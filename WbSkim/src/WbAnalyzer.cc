...
WbAnalyzer::WbAnalyzer (const edm::ParameterSet & iConfig) {
  ...
  w_first_jet_pt =      fs->make < TH1F > ("w_first_jet_pt",    "w_first_jet_pt;P_t [GeV]", 7, 25., 200.);
  h_first_jet_pt =      fs->make < TH1F > ("h_first_jet_pt",    "h_first_jet_pt;P_t [GeV]", 7, 25., 200.);
  b_first_jet_pt =      fs->make < TH1F > ("b_first_jet_pt",    "b_first_jet_pt;P_t [GeV]", 7, 25., 200.);
  c_first_jet_pt =      fs->make < TH1F > ("c_first_jet_pt",    "c_first_jet_pt;P_t [GeV]", 7, 25., 200.);
  t_first_jet_pt =      fs->make < TH1F > ("t_first_jet_pt",    "t_first_jet_pt;P_t [GeV]", 7, 25., 200.);
  w_first_jet_eta =     fs->make < TH1F > ("w_first_jet_eta",   "w_first_jet_eta;Eta", 10, -2.4, 2.4);
  b_first_jet_eta =     fs->make < TH1F > ("b_first_jet_eta",   "b_first_jet_eta;Eta", 10, -2.4, 2.4);
  c_first_jet_eta =     fs->make < TH1F > ("c_first_jet_eta",   "c_first_jet_eta;Eta", 10, -2.4, 2.4);
  t_first_jet_eta =     fs->make < TH1F > ("t_first_jet_eta",   "t_first_jet_eta;Eta", 10, -2.4, 2.4);
  w_first_jet_mass =      fs->make < TH1F > ("w_first_jet_mass",    "w_first_jet_mass;Mass [GeV]", 9, 0., 36.);
  b_first_jet_mass =      fs->make < TH1F > ("b_first_jet_mass",    "b_first_jet_mass;Mass [GeV]", 9, 0., 36.);
  c_first_jet_mass =      fs->make < TH1F > ("c_first_jet_mass",    "c_first_jet_mass;Mass [GeV]", 9, 0., 36.);
  t_first_jet_mass =      fs->make < TH1F > ("t_first_jet_mass",    "t_first_jet_mass;Mass [GeV]", 9, 0., 36.);
  h_second_jet_pt =     fs->make < TH1F > ("h_second_jet_pt",   "h_second_jet_pt;P_t [GeV]", 7, 25., 200.);
  w_second_jet_pt =     fs->make < TH1F > ("w_second_jet_pt",   "w_second_jet_pt;P_t [GeV]", 7, 25., 200.);
  b_second_jet_pt =     fs->make < TH1F > ("b_second_jet_pt",   "b_second_jet_pt;P_t [GeV]", 7, 25., 200.);
  c_second_jet_pt =     fs->make < TH1F > ("c_second_jet_pt",   "c_second_jet_pt;P_t [GeV]", 7, 25., 200.);
  t_second_jet_pt =     fs->make < TH1F > ("t_second_jet_pt",   "t_second_jet_pt;P_t [GeV]", 7, 25., 200.);
  w_second_jet_eta =    fs->make < TH1F > ("w_second_jet_eta",  "w_second_jet_eta;Eta", 10, -2.4, 2.4);
  b_second_jet_eta =    fs->make < TH1F > ("b_second_jet_eta",  "b_second_jet_eta;Eta", 10, -2.4, 2.4);
  c_second_jet_eta =    fs->make < TH1F > ("c_second_jet_eta",  "c_second_jet_eta;Eta", 10, -2.4, 2.4);
  t_second_jet_eta =    fs->make < TH1F > ("t_second_jet_eta",  "t_second_jet_eta;Eta", 10, -2.4, 2.4);
  w_second_jet_mass =      fs->make < TH1F > ("w_second_jet_mass",    "w_second_jet_mass;Mass [GeV]", 9, 0., 36.);
  b_second_jet_mass =      fs->make < TH1F > ("b_second_jet_mass",    "b_second_jet_mass;Mass [GeV]", 9, 0., 36.);
  c_second_jet_mass =      fs->make < TH1F > ("c_second_jet_mass",    "c_second_jet_mass;Mass [GeV]", 9, 0., 36.);
  t_second_jet_mass =      fs->make < TH1F > ("t_second_jet_mass",    "t_second_jet_mass;Mass [GeV]", 9, 0., 36.);
  w_dijet_pt =      fs->make < TH1F > ("w_dijet_pt",    "w_dijet_pt;P_t [GeV]", 8, 0., 200.);
  h_dijet_pt =      fs->make < TH1F > ("h_dijet_pt",    "h_dijet_pt;P_t [GeV]", 8, 0., 200.);
  b_dijet_pt =      fs->make < TH1F > ("b_dijet_pt",    "b_dijet_pt;P_t [GeV]", 8, 0., 200.);
  c_dijet_pt =      fs->make < TH1F > ("c_dijet_pt",    "c_dijet_pt;P_t [GeV]", 8, 0., 200.);
  t_dijet_pt =      fs->make < TH1F > ("t_dijet_pt",    "t_dijet_pt;P_t [GeV]", 8, 0., 200.);
  w_dijet_eta =     fs->make < TH1F > ("w_dijet_eta",   "w_dijet_eta;Eta", 10, -2.4, 2.4);
  b_dijet_eta =     fs->make < TH1F > ("b_dijet_eta",   "b_dijet_eta;Eta", 10, -2.4, 2.4);
  c_dijet_eta =     fs->make < TH1F > ("c_dijet_eta",   "c_dijet_eta;Eta", 10, -2.4, 2.4);
  t_dijet_eta =     fs->make < TH1F > ("t_dijet_eta",   "t_dijet_eta;Eta", 10, -2.4, 2.4);
  w_dijet_mass =      fs->make < TH1F > ("w_dijet_mass",    "w_dijet_mass;Mass [GeV]", 9, 25., 250.);
  b_dijet_mass =      fs->make < TH1F > ("b_dijet_mass",    "b_dijet_mass;Mass [GeV]", 9, 25., 250.);
  c_dijet_mass =      fs->make < TH1F > ("c_dijet_mass",    "c_dijet_mass;Mass [GeV]", 9, 25., 250.);
  t_dijet_mass =      fs->make < TH1F > ("t_dijet_mass",    "t_dijet_mass;Mass [GeV]", 9, 25., 250.);

  h_first_jet_pt_b =    fs->make < TH1F > ("h_first_jet_pt_b",   "h_first_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  w_first_jet_pt_b =    fs->make < TH1F > ("w_first_jet_pt_b",   "w_first_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  b_first_jet_pt_b =    fs->make < TH1F > ("b_first_jet_pt_b",   "b_first_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  c_first_jet_pt_b =    fs->make < TH1F > ("c_first_jet_pt_b",   "c_first_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  t_first_jet_pt_b =    fs->make < TH1F > ("t_first_jet_pt_b",   "t_first_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  w_first_jet_eta_b =   fs->make < TH1F > ("w_first_jet_eta_b",  "w_first_jet_eta_b;Eta", 10, -2.4, 2.4);
  b_first_jet_eta_b =   fs->make < TH1F > ("b_first_jet_eta_b",  "b_first_jet_eta_b;Eta", 10, -2.4, 2.4);
  c_first_jet_eta_b =   fs->make < TH1F > ("c_first_jet_eta_b",  "c_first_jet_eta_b;Eta", 10, -2.4, 2.4);
  t_first_jet_eta_b =   fs->make < TH1F > ("t_first_jet_eta_b",  "t_first_jet_eta_b;Eta", 10, -2.4, 2.4);
  w_first_jet_mass_b =      fs->make < TH1F > ("w_first_jet_mass_b",    "w_first_jet_mass_b;Mass [GeV]", 9, 0., 36.);
  b_first_jet_mass_b =      fs->make < TH1F > ("b_first_jet_mass_b",    "b_first_jet_mass_b;Mass [GeV]", 9, 0., 36.);
  c_first_jet_mass_b =      fs->make < TH1F > ("c_first_jet_mass_b",    "c_first_jet_mass_b;Mass [GeV]", 9, 0., 36.);
  t_first_jet_mass_b =      fs->make < TH1F > ("t_first_jet_mass_b",    "t_first_jet_mass_b;Mass [GeV]", 9, 0., 36.);
  h_second_jet_pt_b =   fs->make < TH1F > ("h_second_jet_pt_b",  "h_second_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  w_second_jet_pt_b =   fs->make < TH1F > ("w_second_jet_pt_b",  "w_second_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  b_second_jet_pt_b =   fs->make < TH1F > ("b_second_jet_pt_b",  "b_second_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  c_second_jet_pt_b =   fs->make < TH1F > ("c_second_jet_pt_b",  "c_second_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  t_second_jet_pt_b =   fs->make < TH1F > ("t_second_jet_pt_b",  "t_second_jet_pt_b;P_t [GeV]", 7, 25., 200.);
  w_second_jet_eta_b =  fs->make < TH1F > ("w_second_jet_eta_b", "w_second_jet_eta_b;Eta", 10, -2.4, 2.4);
  b_second_jet_eta_b =  fs->make < TH1F > ("b_second_jet_eta_b", "b_second_jet_eta_b;Eta", 10, -2.4, 2.4);
  c_second_jet_eta_b =  fs->make < TH1F > ("c_second_jet_eta_b", "c_second_jet_eta_b;Eta", 10, -2.4, 2.4);
  t_second_jet_eta_b =  fs->make < TH1F > ("t_second_jet_eta_b", "t_second_jet_eta_b;Eta", 10, -2.4, 2.4);
  w_second_jet_mass_b =      fs->make < TH1F > ("w_second_jet_mass_b",    "w_second_jet_mass_b;Mass [GeV]", 9, 0., 36.);
  b_second_jet_mass_b =      fs->make < TH1F > ("b_second_jet_mass_b",    "b_second_jet_mass_b;Mass [GeV]", 9, 0., 36.);
  c_second_jet_mass_b =      fs->make < TH1F > ("c_second_jet_mass_b",    "c_second_jet_mass_b;Mass [GeV]", 9, 0., 36.);
  t_second_jet_mass_b =      fs->make < TH1F > ("t_second_jet_mass_b",    "t_second_jet_mass_b;Mass [GeV]", 9, 0., 36.);
  h_dijet_pt_b =    fs->make < TH1F > ("h_dijet_pt_b",   "h_dijet_pt_b;P_t [GeV]", 8, 0., 200.);
  w_dijet_pt_b =    fs->make < TH1F > ("w_dijet_pt_b",   "w_dijet_pt_b;P_t [GeV]", 8, 0., 200.);
  b_dijet_pt_b =    fs->make < TH1F > ("b_dijet_pt_b",   "b_dijet_pt_b;P_t [GeV]", 8, 0., 200.);
  c_dijet_pt_b =    fs->make < TH1F > ("c_dijet_pt_b",   "c_dijet_pt_b;P_t [GeV]", 8, 0., 200.);
  t_dijet_pt_b =    fs->make < TH1F > ("t_dijet_pt_b",   "t_dijet_pt_b;P_t [GeV]", 8, 0., 200.);
  w_dijet_eta_b =   fs->make < TH1F > ("w_dijet_eta_b",  "w_dijet_eta_b;Eta", 10, -2.4, 2.4);
  b_dijet_eta_b =   fs->make < TH1F > ("b_dijet_eta_b",  "b_dijet_eta_b;Eta", 10, -2.4, 2.4);
  c_dijet_eta_b =   fs->make < TH1F > ("c_dijet_eta_b",  "c_dijet_eta_b;Eta", 10, -2.4, 2.4);
  t_dijet_eta_b =   fs->make < TH1F > ("t_dijet_eta_b",  "t_dijet_eta_b;Eta", 10, -2.4, 2.4);
  w_dijet_mass_b =      fs->make < TH1F > ("w_dijet_mass_b",    "w_dijet_mass_b;Mass [GeV]", 9, 25., 250.);
  b_dijet_mass_b =      fs->make < TH1F > ("b_dijet_mass_b",    "b_dijet_mass_b;Mass [GeV]", 9, 25., 250.);
  c_dijet_mass_b =      fs->make < TH1F > ("c_dijet_mass_b",    "c_dijet_mass_b;Mass [GeV]", 9, 25., 250.);
  t_dijet_mass_b =      fs->make < TH1F > ("t_dijet_mass_b",    "t_dijet_mass_b;Mass [GeV]", 9, 25., 250.);

  h_first_jet_pt_bb =    fs->make < TH1F > ("h_first_jet_pt_bb",   "h_first_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  w_first_jet_pt_bb =    fs->make < TH1F > ("w_first_jet_pt_bb",   "w_first_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  b_first_jet_pt_bb =    fs->make < TH1F > ("b_first_jet_pt_bb",   "b_first_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  c_first_jet_pt_bb =    fs->make < TH1F > ("c_first_jet_pt_bb",   "c_first_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  t_first_jet_pt_bb =    fs->make < TH1F > ("t_first_jet_pt_bb",   "t_first_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  w_first_jet_eta_bb =   fs->make < TH1F > ("w_first_jet_eta_bb",  "w_first_jet_eta_bb;Eta", 10, -2.4, 2.4);
  b_first_jet_eta_bb =   fs->make < TH1F > ("b_first_jet_eta_bb",  "b_first_jet_eta_bb;Eta", 10, -2.4, 2.4);
  c_first_jet_eta_bb =   fs->make < TH1F > ("c_first_jet_eta_bb",  "c_first_jet_eta_bb;Eta", 10, -2.4, 2.4);
  t_first_jet_eta_bb =   fs->make < TH1F > ("t_first_jet_eta_bb",  "t_first_jet_eta_bb;Eta", 10, -2.4, 2.4);
  w_first_jet_mass_bb =      fs->make < TH1F > ("w_first_jet_mass_bb",    "w_first_jet_mass_bb;Mass [GeV]", 9, 0., 36.);
  b_first_jet_mass_bb =      fs->make < TH1F > ("b_first_jet_mass_bb",    "b_first_jet_mass_bb;Mass [GeV]", 9, 0., 36.);
  c_first_jet_mass_bb =      fs->make < TH1F > ("c_first_jet_mass_bb",    "c_first_jet_mass_bb;Mass [GeV]", 9, 0., 36.);
  t_first_jet_mass_bb =      fs->make < TH1F > ("t_first_jet_mass_bb",    "t_first_jet_mass_bb;Mass [GeV]", 9, 0., 36.);
  h_second_jet_pt_bb =   fs->make < TH1F > ("h_second_jet_pt_bb",  "h_second_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  w_second_jet_pt_bb =   fs->make < TH1F > ("w_second_jet_pt_bb",  "w_second_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  b_second_jet_pt_bb =   fs->make < TH1F > ("b_second_jet_pt_bb",  "b_second_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  c_second_jet_pt_bb =   fs->make < TH1F > ("c_second_jet_pt_bb",  "c_second_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  t_second_jet_pt_bb =   fs->make < TH1F > ("t_second_jet_pt_bb",  "t_second_jet_pt_bb;P_t [GeV]", 7, 25., 200.);
  w_second_jet_eta_bb =  fs->make < TH1F > ("w_second_jet_eta_bb", "w_second_jet_eta_bb;Eta", 10, -2.4, 2.4);
  b_second_jet_eta_bb =  fs->make < TH1F > ("b_second_jet_eta_bb", "b_second_jet_eta_bb;Eta", 10, -2.4, 2.4);
  c_second_jet_eta_bb =  fs->make < TH1F > ("c_second_jet_eta_bb", "c_second_jet_eta_bb;Eta", 10, -2.4, 2.4);
  t_second_jet_eta_bb =  fs->make < TH1F > ("t_second_jet_eta_bb", "t_second_jet_eta_bb;Eta", 10, -2.4, 2.4);
  w_second_jet_mass_bb =      fs->make < TH1F > ("w_second_jet_mass_bb",    "w_second_jet_mass_bb;Mass [GeV]", 9, 0., 36.);
  b_second_jet_mass_bb =      fs->make < TH1F > ("b_second_jet_mass_bb",    "b_second_jet_mass_bb;Mass [GeV]", 9, 0., 36.);
  c_second_jet_mass_bb =      fs->make < TH1F > ("c_second_jet_mass_bb",    "c_second_jet_mass_bb;Mass [GeV]", 9, 0., 36.);
  t_second_jet_mass_bb =      fs->make < TH1F > ("t_second_jet_mass_bb",    "t_second_jet_mass_bb;Mass [GeV]", 9, 0., 36.);
  h_dijet_pt_bb =    fs->make < TH1F > ("h_dijet_pt_bb",   "h_dijet_pt_bb;P_t [GeV]", 8, 0., 200.);
  w_dijet_pt_bb =    fs->make < TH1F > ("w_dijet_pt_bb",   "w_dijet_pt_bb;P_t [GeV]", 8, 0., 200.);
  b_dijet_pt_bb =    fs->make < TH1F > ("b_dijet_pt_bb",   "b_dijet_pt_bb;P_t [GeV]", 8, 0., 200.);
  c_dijet_pt_bb =    fs->make < TH1F > ("c_dijet_pt_bb",   "c_dijet_pt_bb;P_t [GeV]", 8, 0., 200.);
  t_dijet_pt_bb =    fs->make < TH1F > ("t_dijet_pt_bb",   "t_dijet_pt_bb;P_t [GeV]", 8, 0., 200.);
  w_dijet_eta_bb =   fs->make < TH1F > ("w_dijet_eta_bb",  "w_dijet_eta_bb;Eta", 10, -2.4, 2.4);
  b_dijet_eta_bb =   fs->make < TH1F > ("b_dijet_eta_bb",  "b_dijet_eta_bb;Eta", 10, -2.4, 2.4);
  c_dijet_eta_bb =   fs->make < TH1F > ("c_dijet_eta_bb",  "c_dijet_eta_bb;Eta", 10, -2.4, 2.4);
  t_dijet_eta_bb =   fs->make < TH1F > ("t_dijet_eta_bb",  "t_dijet_eta_bb;Eta", 10, -2.4, 2.4);
  w_dijet_mass_bb =      fs->make < TH1F > ("w_dijet_mass_bb",    "w_dijet_mass_bb;Mass [GeV]", 9, 25., 250.);
  b_dijet_mass_bb =      fs->make < TH1F > ("b_dijet_mass_bb",    "b_dijet_mass_bb;Mass [GeV]", 9, 25., 250.);
  c_dijet_mass_bb =      fs->make < TH1F > ("c_dijet_mass_bb",    "c_dijet_mass_bb;Mass [GeV]", 9, 25., 250.);
  t_dijet_mass_bb =      fs->make < TH1F > ("t_dijet_mass_bb",    "t_dijet_mass_bb;Mass [GeV]", 9, 25., 250.);
  ...
  h_first_bjet_pt =     fs->make < TH1F > ("h_first_bjet_pt",    "h_first_bjet_pt;P_t [GeV]", 7, 25., 200.);
  w_first_bjet_pt =     fs->make < TH1F > ("w_first_bjet_pt",    "w_first_bjet_pt;P_t [GeV]", 7, 25., 200.);
  b_first_bjet_pt =     fs->make < TH1F > ("b_first_bjet_pt",    "b_first_bjet_pt;P_t [GeV]", 7, 25., 200.);
  c_first_bjet_pt =     fs->make < TH1F > ("c_first_bjet_pt",    "c_first_bjet_pt;P_t [GeV]", 7, 25., 200.);
  t_first_bjet_pt =     fs->make < TH1F > ("t_first_bjet_pt",    "t_first_bjet_pt;P_t [GeV]", 7, 25., 200.);
  w_first_bjet_eta =    fs->make < TH1F > ("w_first_bjet_eta",   "w_first_bjet_eta;Eta", 10, -2.4, 2.4);
  b_first_bjet_eta =    fs->make < TH1F > ("b_first_bjet_eta",   "b_first_bjet_eta;Eta", 10, -2.4, 2.4);
  c_first_bjet_eta =    fs->make < TH1F > ("c_first_bjet_eta",   "c_first_bjet_eta;Eta", 10, -2.4, 2.4);
  t_first_bjet_eta =    fs->make < TH1F > ("t_first_bjet_eta",   "t_first_bjet_eta;Eta", 10, -2.4, 2.4);
  w_first_bjet_mass =      fs->make < TH1F > ("w_first_bjet_mass",    "w_first_bjet_mass;Mass [GeV]", 9, 0., 36.);
  b_first_bjet_mass =      fs->make < TH1F > ("b_first_bjet_mass",    "b_first_bjet_mass;Mass [GeV]", 9, 0., 36.);
  c_first_bjet_mass =      fs->make < TH1F > ("c_first_bjet_mass",    "c_first_bjet_mass;Mass [GeV]", 9, 0., 36.);
  t_first_bjet_mass =      fs->make < TH1F > ("t_first_bjet_mass",    "t_first_bjet_mass;Mass [GeV]", 9, 0., 36.);

  w_single_bjet_pt =    fs->make < TH1F > ("w_single_bjet_pt",    "w_single_bjet_pt;P_t [GeV]", 7, 25., 200.);
  b_single_bjet_pt =    fs->make < TH1F > ("b_single_bjet_pt",    "b_single_bjet_pt;P_t [GeV]", 7, 25., 200.);
  c_single_bjet_pt =    fs->make < TH1F > ("c_single_bjet_pt",    "c_single_bjet_pt;P_t [GeV]", 7, 25., 200.);
  t_single_bjet_pt =    fs->make < TH1F > ("t_single_bjet_pt",    "t_single_bjet_pt;P_t [GeV]", 7, 25., 200.);
  w_single_bjet_eta =   fs->make < TH1F > ("w_single_bjet_eta",   "w_single_bjet_eta;Eta", 10, -2.4, 2.4);
  b_single_bjet_eta =   fs->make < TH1F > ("b_single_bjet_eta",   "b_single_bjet_eta;Eta", 10, -2.4, 2.4);
  c_single_bjet_eta =   fs->make < TH1F > ("c_single_bjet_eta",   "c_single_bjet_eta;Eta", 10, -2.4, 2.4);
  t_single_bjet_eta =   fs->make < TH1F > ("t_single_bjet_eta",   "t_single_bjet_eta;Eta", 10, -2.4, 2.4);
  w_single_bjet_mass =      fs->make < TH1F > ("w_single_bjet_mass",    "w_single_bjet_mass;Mass [GeV]", 9, 0., 36.);
  b_single_bjet_mass =      fs->make < TH1F > ("b_single_bjet_mass",    "b_single_bjet_mass;Mass [GeV]", 9, 0., 36.);
  c_single_bjet_mass =      fs->make < TH1F > ("c_single_bjet_mass",    "c_single_bjet_mass;Mass [GeV]", 9, 0., 36.);
  t_single_bjet_mass =      fs->make < TH1F > ("t_single_bjet_mass",    "t_single_bjet_mass;Mass [GeV]", 9, 0., 36.);

  h_second_bjet_pt =    fs->make < TH1F > ("h_second_bjet_pt",   "h_second_bjet_pt;P_t [GeV]", 7, 25., 200.);
  w_second_bjet_pt =    fs->make < TH1F > ("w_second_bjet_pt",   "w_second_bjet_pt;P_t [GeV]", 7, 25., 200.);
  b_second_bjet_pt =    fs->make < TH1F > ("b_second_bjet_pt",   "b_second_bjet_pt;P_t [GeV]", 7, 25., 200.);
  c_second_bjet_pt =    fs->make < TH1F > ("c_second_bjet_pt",   "c_second_bjet_pt;P_t [GeV]", 7, 25., 200.);
  t_second_bjet_pt =    fs->make < TH1F > ("t_second_bjet_pt",   "t_second_bjet_pt;P_t [GeV]", 7, 25., 200.);
  w_second_bjet_eta =   fs->make < TH1F > ("w_second_bjet_eta",  "w_second_bjet_eta;Eta", 10, -2.4, 2.4);
  b_second_bjet_eta =   fs->make < TH1F > ("b_second_bjet_eta",  "b_second_bjet_eta;Eta", 10, -2.4, 2.4);
  c_second_bjet_eta =   fs->make < TH1F > ("c_second_bjet_eta",  "c_second_bjet_eta;Eta", 10, -2.4, 2.4);
  t_second_bjet_eta =   fs->make < TH1F > ("t_second_bjet_eta",  "t_second_bjet_eta;Eta", 10, -2.4, 2.4);
  w_second_bjet_mass =      fs->make < TH1F > ("w_second_bjet_mass",    "w_second_bjet_mass;Mass [GeV]", 9, 0., 36.);
  b_second_bjet_mass =      fs->make < TH1F > ("b_second_bjet_mass",    "b_second_bjet_mass;Mass [GeV]", 9, 0., 36.);
  c_second_bjet_mass =      fs->make < TH1F > ("c_second_bjet_mass",    "c_second_bjet_mass;Mass [GeV]", 9, 0., 36.);
  t_second_bjet_mass =      fs->make < TH1F > ("t_second_bjet_mass",    "t_second_bjet_mass;Mass [GeV]", 9, 0., 36.);
  ...
  w_pt_W_wenu =           fs->make < TH1F > ("w_pt_W_wenu",         "w_pt_W_wenu;P_t [GeV]", 8, 0., 200.);
  b_pt_W_wenu =           fs->make < TH1F > ("b_pt_W_wenu",         "b_pt_W_wenu;P_t [GeV]", 8, 0., 200.);
  c_pt_W_wenu =           fs->make < TH1F > ("c_pt_W_wenu",         "c_pt_W_wenu;P_t [GeV]", 8, 0., 200.);
  t_pt_W_wenu =           fs->make < TH1F > ("t_pt_W_wenu",         "t_pt_W_wenu;P_t [GeV]", 8, 0., 200.);

  w_pt_W_wmnu =           fs->make < TH1F > ("w_pt_W_wmnu",         "w_pt_W_wmnu;P_t [GeV]", 8, 0., 200.);
  b_pt_W_wmnu =           fs->make < TH1F > ("b_pt_W_wmnu",         "b_pt_W_wmnu;P_t [GeV]", 8, 0., 200.);
  c_pt_W_wmnu =           fs->make < TH1F > ("c_pt_W_wmnu",         "c_pt_W_wmnu;P_t [GeV]", 8, 0., 200.);
  t_pt_W_wmnu =           fs->make < TH1F > ("t_pt_W_wmnu",         "t_pt_W_wmnu;P_t [GeV]", 8, 0., 200.);

  w_pt_W_wenu_b =           fs->make < TH1F > ("w_pt_W_wenu_b",         "w_pt_W_wenu_b;P_t [GeV]", 8, 0., 200.);
  b_pt_W_wenu_b =           fs->make < TH1F > ("b_pt_W_wenu_b",         "b_pt_W_wenu_b;P_t [GeV]", 8, 0., 200.);
  c_pt_W_wenu_b =           fs->make < TH1F > ("c_pt_W_wenu_b",         "c_pt_W_wenu_b;P_t [GeV]", 8, 0., 200.);
  t_pt_W_wenu_b =           fs->make < TH1F > ("t_pt_W_wenu_b",         "t_pt_W_wenu_b;P_t [GeV]", 8, 0., 200.);

  w_pt_W_wmnu_b =           fs->make < TH1F > ("w_pt_W_wmnu_b",         "w_pt_W_wmnu_b;P_t [GeV]", 8, 0., 200.);
  b_pt_W_wmnu_b =           fs->make < TH1F > ("b_pt_W_wmnu_b",         "b_pt_W_wmnu_b;P_t [GeV]", 8, 0., 200.);
  c_pt_W_wmnu_b =           fs->make < TH1F > ("c_pt_W_wmnu_b",         "c_pt_W_wmnu_b;P_t [GeV]", 8, 0., 200.);
  t_pt_W_wmnu_b =           fs->make < TH1F > ("t_pt_W_wmnu_b",         "t_pt_W_wmnu_b;P_t [GeV]", 8, 0., 200.);

  w_pt_W_wenu_bb =           fs->make < TH1F > ("w_pt_W_wenu_bb",         "w_pt_W_wenu_bb;P_t [GeV]", 8, 0., 200.);
  b_pt_W_wenu_bb =           fs->make < TH1F > ("b_pt_W_wenu_bb",         "b_pt_W_wenu_bb;P_t [GeV]", 8, 0., 200.);
  c_pt_W_wenu_bb =           fs->make < TH1F > ("c_pt_W_wenu_bb",         "c_pt_W_wenu_bb;P_t [GeV]", 8, 0., 200.);
  t_pt_W_wenu_bb =           fs->make < TH1F > ("t_pt_W_wenu_bb",         "t_pt_W_wenu_bb;P_t [GeV]", 8, 0., 200.);

  w_pt_W_wmnu_bb =           fs->make < TH1F > ("w_pt_W_wmnu_bb",         "w_pt_W_wmnu_bb;P_t [GeV]", 8, 0., 200.);
  b_pt_W_wmnu_bb =           fs->make < TH1F > ("b_pt_W_wmnu_bb",         "b_pt_W_wmnu_bb;P_t [GeV]", 8, 0., 200.);
  c_pt_W_wmnu_bb =           fs->make < TH1F > ("c_pt_W_wmnu_bb",         "c_pt_W_wmnu_bb;P_t [GeV]", 8, 0., 200.);
  t_pt_W_wmnu_bb =           fs->make < TH1F > ("t_pt_W_wmnu_bb",         "t_pt_W_wmnu_bb;P_t [GeV]", 8, 0., 200.);

  w_eta_W_wenu =           fs->make < TH1F > ("w_eta_W_wenu",         "w_eta_W_wenu;Eta", 10, -2.4, 2.4);
  b_eta_W_wenu =           fs->make < TH1F > ("b_eta_W_wenu",         "b_eta_W_wenu;Eta", 10, -2.4, 2.4);
  c_eta_W_wenu =           fs->make < TH1F > ("c_eta_W_wenu",         "c_eta_W_wenu;Eta", 10, -2.4, 2.4);
  t_eta_W_wenu =           fs->make < TH1F > ("t_eta_W_wenu",         "t_eta_W_wenu;Eta", 10, -2.4, 2.4);

  w_eta_W_wmnu =           fs->make < TH1F > ("w_eta_W_wmnu",         "w_eta_W_wmnu;Eta", 10, -2.4, 2.4);
  b_eta_W_wmnu =           fs->make < TH1F > ("b_eta_W_wmnu",         "b_eta_W_wmnu;Eta", 10, -2.4, 2.4);
  c_eta_W_wmnu =           fs->make < TH1F > ("c_eta_W_wmnu",         "c_eta_W_wmnu;Eta", 10, -2.4, 2.4);
  t_eta_W_wmnu =           fs->make < TH1F > ("t_eta_W_wmnu",         "t_eta_W_wmnu;Eta", 10, -2.4, 2.4);

  w_eta_W_wenu_b =           fs->make < TH1F > ("w_eta_W_wenu_b",         "w_eta_W_wenu_b;Eta", 10, -2.4, 2.4);
  b_eta_W_wenu_b =           fs->make < TH1F > ("b_eta_W_wenu_b",         "b_eta_W_wenu_b;Eta", 10, -2.4, 2.4);
  c_eta_W_wenu_b =           fs->make < TH1F > ("c_eta_W_wenu_b",         "c_eta_W_wenu_b;Eta", 10, -2.4, 2.4);
  t_eta_W_wenu_b =           fs->make < TH1F > ("t_eta_W_wenu_b",         "t_eta_W_wenu_b;Eta", 10, -2.4, 2.4);

  w_eta_W_wmnu_b =           fs->make < TH1F > ("w_eta_W_wmnu_b",         "w_eta_W_wmnu_b;Eta", 10, -2.4, 2.4);
  b_eta_W_wmnu_b =           fs->make < TH1F > ("b_eta_W_wmnu_b",         "b_eta_W_wmnu_b;Eta", 10, -2.4, 2.4);
  c_eta_W_wmnu_b =           fs->make < TH1F > ("c_eta_W_wmnu_b",         "c_eta_W_wmnu_b;Eta", 10, -2.4, 2.4);
  t_eta_W_wmnu_b =           fs->make < TH1F > ("t_eta_W_wmnu_b",         "t_eta_W_wmnu_b;Eta", 10, -2.4, 2.4);

  w_eta_W_wenu_bb =           fs->make < TH1F > ("w_eta_W_wenu_bb",         "w_eta_W_wenu_bb;Eta", 10, -2.4, 2.4);
  b_eta_W_wenu_bb =           fs->make < TH1F > ("b_eta_W_wenu_bb",         "b_eta_W_wenu_bb;Eta", 10, -2.4, 2.4);
  c_eta_W_wenu_bb =           fs->make < TH1F > ("c_eta_W_wenu_bb",         "c_eta_W_wenu_bb;Eta", 10, -2.4, 2.4);
  t_eta_W_wenu_bb =           fs->make < TH1F > ("t_eta_W_wenu_bb",         "t_eta_W_wenu_bb;Eta", 10, -2.4, 2.4);

  w_eta_W_wmnu_bb =           fs->make < TH1F > ("w_eta_W_wmnu_bb",         "w_eta_W_wmnu_bb;Eta", 10, -2.4, 2.4);
  b_eta_W_wmnu_bb =           fs->make < TH1F > ("b_eta_W_wmnu_bb",         "b_eta_W_wmnu_bb;Eta", 10, -2.4, 2.4);
  c_eta_W_wmnu_bb =           fs->make < TH1F > ("c_eta_W_wmnu_bb",         "c_eta_W_wmnu_bb;Eta", 10, -2.4, 2.4);
  t_eta_W_wmnu_bb =           fs->make < TH1F > ("t_eta_W_wmnu_bb",         "t_eta_W_wmnu_bb;Eta", 10, -2.4, 2.4);
  ...
  w_delta_wenu =          fs->make < TH1F > ("w_delta_wenu",     "w_delta_wenu",    8, 0., TMath::Pi ());
  b_delta_wenu =          fs->make < TH1F > ("b_delta_wenu",     "b_delta_wenu",    8, 0., TMath::Pi ());
  c_delta_wenu =          fs->make < TH1F > ("c_delta_wenu",     "c_delta_wenu",    8, 0., TMath::Pi ());
  t_delta_wenu =          fs->make < TH1F > ("t_delta_wenu",     "t_delta_wenu",    8, 0., TMath::Pi ());
  w_delta_wenu_b =        fs->make < TH1F > ("w_delta_wenu_b",   "w_delta_wenu_b",  8, 0., TMath::Pi ());
  b_delta_wenu_b =        fs->make < TH1F > ("b_delta_wenu_b",   "b_delta_wenu_b",  8, 0., TMath::Pi ());
  c_delta_wenu_b =        fs->make < TH1F > ("c_delta_wenu_b",   "c_delta_wenu_b",  8, 0., TMath::Pi ());
  t_delta_wenu_b =        fs->make < TH1F > ("t_delta_wenu_b",   "t_delta_wenu_b",  8, 0., TMath::Pi ());
  w_delta_wenu_bb =       fs->make < TH1F > ("w_delta_wenu_bb",  "w_delta_wenu_bb", 8, 0., TMath::Pi ());
  b_delta_wenu_bb =       fs->make < TH1F > ("b_delta_wenu_bb",  "b_delta_wenu_bb", 8, 0., TMath::Pi ());
  c_delta_wenu_bb =       fs->make < TH1F > ("c_delta_wenu_bb",  "c_delta_wenu_bb", 8, 0., TMath::Pi ());
  t_delta_wenu_bb =       fs->make < TH1F > ("t_delta_wenu_bb",  "t_delta_wenu_bb", 8, 0., TMath::Pi ());
  w_delta_wenu_2b =       fs->make < TH1F > ("w_delta_wenu_2b",  "w_delta_wenu_2b", 8, 0., TMath::Pi ());
  b_delta_wenu_2b =       fs->make < TH1F > ("b_delta_wenu_2b",  "b_delta_wenu_2b", 8, 0., TMath::Pi ());
  c_delta_wenu_2b =       fs->make < TH1F > ("c_delta_wenu_2b",  "c_delta_wenu_2b", 8, 0., TMath::Pi ());
  t_delta_wenu_2b =       fs->make < TH1F > ("t_delta_wenu_2b",  "t_delta_wenu_2b", 8, 0., TMath::Pi ());

  w_delta_wmnu =          fs->make < TH1F > ("w_delta_wmnu",     "w_delta_wmnu",    8, 0., TMath::Pi ());
  b_delta_wmnu =          fs->make < TH1F > ("b_delta_wmnu",     "b_delta_wmnu",    8, 0., TMath::Pi ());
  c_delta_wmnu =          fs->make < TH1F > ("c_delta_wmnu",     "c_delta_wmnu",    8, 0., TMath::Pi ());
  t_delta_wmnu =          fs->make < TH1F > ("t_delta_wmnu",     "t_delta_wmnu",    8, 0., TMath::Pi ());
  w_delta_wmnu_b =        fs->make < TH1F > ("w_delta_wmnu_b",   "w_delta_wmnu_b",  8, 0., TMath::Pi ());
  b_delta_wmnu_b =        fs->make < TH1F > ("b_delta_wmnu_b",   "b_delta_wmnu_b",  8, 0., TMath::Pi ());
  c_delta_wmnu_b =        fs->make < TH1F > ("c_delta_wmnu_b",   "c_delta_wmnu_b",  8, 0., TMath::Pi ());
  t_delta_wmnu_b =        fs->make < TH1F > ("t_delta_wmnu_b",   "t_delta_wmnu_b",  8, 0., TMath::Pi ());
  w_delta_wmnu_bb =       fs->make < TH1F > ("w_delta_wmnu_bb",  "w_delta_wmnu_bb", 8, 0., TMath::Pi ());
  b_delta_wmnu_bb =       fs->make < TH1F > ("b_delta_wmnu_bb",  "b_delta_wmnu_bb", 8, 0., TMath::Pi ());
  c_delta_wmnu_bb =       fs->make < TH1F > ("c_delta_wmnu_bb",  "c_delta_wmnu_bb", 8, 0., TMath::Pi ());
  t_delta_wmnu_bb =       fs->make < TH1F > ("t_delta_wmnu_bb",  "t_delta_wmnu_bb", 8, 0., TMath::Pi ());
  w_delta_wmnu_2b =       fs->make < TH1F > ("w_delta_wmnu_2b",  "w_delta_wmnu_2b", 8, 0., TMath::Pi ());
  b_delta_wmnu_2b =       fs->make < TH1F > ("b_delta_wmnu_2b",  "b_delta_wmnu_2b", 8, 0., TMath::Pi ());
  c_delta_wmnu_2b =       fs->make < TH1F > ("c_delta_wmnu_2b",  "c_delta_wmnu_2b", 8, 0., TMath::Pi ());
  t_delta_wmnu_2b =       fs->make < TH1F > ("t_delta_wmnu_2b",  "t_delta_wmnu_2b", 8, 0., TMath::Pi ());

  w_deltaR_wenu =          fs->make < TH1F > ("w_deltaR_wenu",     "w_deltaR_wenu",    8, 0., 4.8);
  b_deltaR_wenu =          fs->make < TH1F > ("b_deltaR_wenu",     "b_deltaR_wenu",    8, 0., 4.8);
  c_deltaR_wenu =          fs->make < TH1F > ("c_deltaR_wenu",     "c_deltaR_wenu",    8, 0., 4.8);
  t_deltaR_wenu =          fs->make < TH1F > ("t_deltaR_wenu",     "t_deltaR_wenu",    8, 0., 4.8);
  w_deltaR_wenu_b =        fs->make < TH1F > ("w_deltaR_wenu_b",   "w_deltaR_wenu_b",  8, 0., 4.8);
  b_deltaR_wenu_b =        fs->make < TH1F > ("b_deltaR_wenu_b",   "b_deltaR_wenu_b",  8, 0., 4.8);
  c_deltaR_wenu_b =        fs->make < TH1F > ("c_deltaR_wenu_b",   "c_deltaR_wenu_b",  8, 0., 4.8);
  t_deltaR_wenu_b =        fs->make < TH1F > ("t_deltaR_wenu_b",   "t_deltaR_wenu_b",  8, 0., 4.8);
  w_deltaR_wenu_bb =       fs->make < TH1F > ("w_deltaR_wenu_bb",  "w_deltaR_wenu_bb", 8, 0., 4.8);
  b_deltaR_wenu_bb =       fs->make < TH1F > ("b_deltaR_wenu_bb",  "b_deltaR_wenu_bb", 8, 0., 4.8);
  c_deltaR_wenu_bb =       fs->make < TH1F > ("c_deltaR_wenu_bb",  "c_deltaR_wenu_bb", 8, 0., 4.8);
  t_deltaR_wenu_bb =       fs->make < TH1F > ("t_deltaR_wenu_bb",  "t_deltaR_wenu_bb", 8, 0., 4.8);
  w_deltaR_wenu_2b =       fs->make < TH1F > ("w_deltaR_wenu_2b",  "w_deltaR_wenu_2b", 8, 0., 4.8);
  b_deltaR_wenu_2b =       fs->make < TH1F > ("b_deltaR_wenu_2b",  "b_deltaR_wenu_2b", 8, 0., 4.8);
  c_deltaR_wenu_2b =       fs->make < TH1F > ("c_deltaR_wenu_2b",  "c_deltaR_wenu_2b", 8, 0., 4.8);
  t_deltaR_wenu_2b =       fs->make < TH1F > ("t_deltaR_wenu_2b",  "t_deltaR_wenu_2b", 8, 0., 4.8);

  w_deltaR_wmnu =          fs->make < TH1F > ("w_deltaR_wmnu",     "w_deltaR_wmnu",    8, 0., 4.8);
  b_deltaR_wmnu =          fs->make < TH1F > ("b_deltaR_wmnu",     "b_deltaR_wmnu",    8, 0., 4.8);
  c_deltaR_wmnu =          fs->make < TH1F > ("c_deltaR_wmnu",     "c_deltaR_wmnu",    8, 0., 4.8);
  t_deltaR_wmnu =          fs->make < TH1F > ("t_deltaR_wmnu",     "t_deltaR_wmnu",    8, 0., 4.8);
  w_deltaR_wmnu_b =        fs->make < TH1F > ("w_deltaR_wmnu_b",   "w_deltaR_wmnu_b",  8, 0., 4.8);
  b_deltaR_wmnu_b =        fs->make < TH1F > ("b_deltaR_wmnu_b",   "b_deltaR_wmnu_b",  8, 0., 4.8);
  c_deltaR_wmnu_b =        fs->make < TH1F > ("c_deltaR_wmnu_b",   "c_deltaR_wmnu_b",  8, 0., 4.8);
  t_deltaR_wmnu_b =        fs->make < TH1F > ("t_deltaR_wmnu_b",   "t_deltaR_wmnu_b",  8, 0., 4.8);
  w_deltaR_wmnu_bb =       fs->make < TH1F > ("w_deltaR_wmnu_bb",  "w_deltaR_wmnu_bb", 8, 0., 4.8);
  b_deltaR_wmnu_bb =       fs->make < TH1F > ("b_deltaR_wmnu_bb",  "b_deltaR_wmnu_bb", 8, 0., 4.8);
  c_deltaR_wmnu_bb =       fs->make < TH1F > ("c_deltaR_wmnu_bb",  "c_deltaR_wmnu_bb", 8, 0., 4.8);
  t_deltaR_wmnu_bb =       fs->make < TH1F > ("t_deltaR_wmnu_bb",  "t_deltaR_wmnu_bb", 8, 0., 4.8);
  w_deltaR_wmnu_2b =       fs->make < TH1F > ("w_deltaR_wmnu_2b",  "w_deltaR_wmnu_2b", 8, 0., 4.8);
  b_deltaR_wmnu_2b =       fs->make < TH1F > ("b_deltaR_wmnu_2b",  "b_deltaR_wmnu_2b", 8, 0., 4.8);
  c_deltaR_wmnu_2b =       fs->make < TH1F > ("c_deltaR_wmnu_2b",  "c_deltaR_wmnu_2b", 8, 0., 4.8);
  t_deltaR_wmnu_2b =       fs->make < TH1F > ("t_deltaR_wmnu_2b",  "t_deltaR_wmnu_2b", 8, 0., 4.8);
  ...
  w_single_delta_wenu_b =        fs->make < TH1F > ("w_single_delta_wenu_b",  "w_single_delta_wenu_b", 8, 0., TMath::Pi ());
  b_single_delta_wenu_b =        fs->make < TH1F > ("b_single_delta_wenu_b",  "b_single_delta_wenu_b", 8, 0., TMath::Pi ());
  c_single_delta_wenu_b =        fs->make < TH1F > ("c_single_delta_wenu_b",  "c_single_delta_wenu_b", 8, 0., TMath::Pi ());
  t_single_delta_wenu_b =        fs->make < TH1F > ("t_single_delta_wenu_b",  "t_single_delta_wenu_b", 8, 0., TMath::Pi ());

  w_single_delta_wmnu_b =        fs->make < TH1F > ("w_single_delta_wmnu_b",  "w_single_delta_wmnu_b", 8, 0., TMath::Pi ());
  b_single_delta_wmnu_b =        fs->make < TH1F > ("b_single_delta_wmnu_b",  "b_single_delta_wmnu_b", 8, 0., TMath::Pi ());
  c_single_delta_wmnu_b =        fs->make < TH1F > ("c_single_delta_wmnu_b",  "c_single_delta_wmnu_b", 8, 0., TMath::Pi ());
  t_single_delta_wmnu_b =        fs->make < TH1F > ("t_single_delta_wmnu_b",  "t_single_delta_wmnu_b", 8, 0., TMath::Pi ());

  w_single_deltaR_wenu_b =        fs->make < TH1F > ("w_single_deltaR_wenu_b",  "w_single_deltaR_wenu_b", 8, 0., TMath::Pi ());
  b_single_deltaR_wenu_b =        fs->make < TH1F > ("b_single_deltaR_wenu_b",  "b_single_deltaR_wenu_b", 8, 0., TMath::Pi ());
  c_single_deltaR_wenu_b =        fs->make < TH1F > ("c_single_deltaR_wenu_b",  "c_single_deltaR_wenu_b", 8, 0., TMath::Pi ());
  t_single_deltaR_wenu_b =        fs->make < TH1F > ("t_single_deltaR_wenu_b",  "t_single_deltaR_wenu_b", 8, 0., TMath::Pi ());

  w_single_deltaR_wmnu_b =        fs->make < TH1F > ("w_single_deltaR_wmnu_b",  "w_single_deltaR_wmnu_b", 8, 0., TMath::Pi ());
  b_single_deltaR_wmnu_b =        fs->make < TH1F > ("b_single_deltaR_wmnu_b",  "b_single_deltaR_wmnu_b", 8, 0., TMath::Pi ());
  c_single_deltaR_wmnu_b =        fs->make < TH1F > ("c_single_deltaR_wmnu_b",  "c_single_deltaR_wmnu_b", 8, 0., TMath::Pi ());
  t_single_deltaR_wmnu_b =        fs->make < TH1F > ("t_single_deltaR_wmnu_b",  "t_single_deltaR_wmnu_b", 8, 0., TMath::Pi ());
  ...
  w_Ht =                fs->make < TH1F > ("w_Ht",              "w_Ht [GeV]", 7, 25., 200.);
  b_Ht =                fs->make < TH1F > ("b_Ht",              "b_Ht [GeV]", 7, 25., 200.);
  c_Ht =                fs->make < TH1F > ("c_Ht",              "c_Ht [GeV]", 7, 25., 200.);
  t_Ht =                fs->make < TH1F > ("t_Ht",              "t_Ht [GeV]", 7, 25., 200.);

  w_Ht_b =              fs->make < TH1F > ("w_Ht_b",            "w_Ht_b [GeV]", 7, 25., 200.);
  b_Ht_b =              fs->make < TH1F > ("b_Ht_b",            "b_Ht_b [GeV]", 7, 25., 200.);
  c_Ht_b =              fs->make < TH1F > ("c_Ht_b",            "c_Ht_b [GeV]", 7, 25., 200.);
  t_Ht_b =              fs->make < TH1F > ("t_Ht_b",            "t_Ht_b [GeV]", 7, 25., 200.);

  w_Ht_bb =             fs->make < TH1F > ("w_Ht_bb",           "w_Ht_bb [GeV]", 7, 25., 200.);
  b_Ht_bb =             fs->make < TH1F > ("b_Ht_bb",           "b_Ht_bb [GeV]", 7, 25., 200.);
  c_Ht_bb =             fs->make < TH1F > ("c_Ht_bb",           "c_Ht_bb [GeV]", 7, 25., 200.);
  t_Ht_bb =             fs->make < TH1F > ("t_Ht_bb",           "t_Ht_bb [GeV]", 7, 25., 200.);

  w_single_Ht_b =       fs->make < TH1F > ("w_single_Ht_b",            "w_single_Ht_b [GeV]", 7, 25., 200.);
  b_single_Ht_b =       fs->make < TH1F > ("b_single_Ht_b",            "b_single_Ht_b [GeV]", 7, 25., 200.);
  c_single_Ht_b =       fs->make < TH1F > ("c_single_Ht_b",            "c_single_Ht_b [GeV]", 7, 25., 200.);
  t_single_Ht_b =       fs->make < TH1F > ("t_single_Ht_b",            "t_single_Ht_b [GeV]", 7, 25., 200.);
...
//    }
  ...
  } else if (lepton_=="electronTOP" || lepton_=="muonTOP") {
    wenu_event = wenu_event && Nb>1 && Nj>2 && vect_bjets[0].p4() == vect_jets[0].p4() && vect_bjets[1].p4() == vect_jets[1].p4();
    wmnu_event = wmnu_event && Nb>1 && Nj>2 && vect_bjets[0].p4() == vect_jets[0].p4() && vect_bjets[1].p4() == vect_jets[1].p4();
  } else {
