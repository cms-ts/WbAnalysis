...
void WbAnalyzer::produce (edm::Event & iEvent, const edm::EventSetup & iSetup) {
  ...
  if (wmnu_event && mt_cut_wmnu && vtx_cut) {
    ...
    w_first_muon_iso->Fill (vect_muon[0].chargedHadronIso() + fmax(vect_muon[0].photonIso() + vect_muon[0].neutralHadronIso() - 0.5*vect_muon[0].puChargedHadronIso(),0.0))/vect_muon[0].pt(), MyWeight*scalFac_b);
    ...
    if (ist) {
      ...
      t_first_muon_iso->Fill (vect_muon[0].chargedHadronIso() + fmax(vect_muon[0].photonIso() + vect_muon[0].neutralHadronIso() - 0.5*vect_muon[0].puChargedHadronIso(),0.0))/vect_muon[0].pt(), MyWeight*scalFac_b);
      if (mm_event) { // temporary !!!
    ...
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 5) {
      ...
      b_first_muon_iso->Fill (vect_muon[0].chargedHadronIso() + fmax(vect_muon[0].photonIso() + vect_muon[0].neutralHadronIso() - 0.5*vect_muon[0].puChargedHadronIso(),0.0))/vect_muon[0].pt(), MyWeight*scalFac_b);
      if (mm_event) { // temporary !!!
    ...
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 4) {
      ...
      c_first_muon_iso->Fill (vect_muon[0].chargedHadronIso() + fmax(vect_muon[0].photonIso() + vect_muon[0].neutralHadronIso() - 0.5*vect_muon[0].puChargedHadronIso(),0.0))/vect_muon[0].pt(), MyWeight*scalFac_b);
      if (mm_event) { // temporary !!!
