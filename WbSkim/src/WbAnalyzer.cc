...
#define ECALDRIVEN 0
  ...
  //  TH1F*     w_single_delta_em_bb;
  //  TH1F*     b_single_delta_em_bb;
  //  TH1F*     c_single_delta_em_bb;
  //  TH1F*     t_single_delta_em_bb;
...
WbAnalyzer::WbAnalyzer (const edm::ParameterSet & iConfig) {
  ...
  w_delta_wenuMet =          fs->make < TH1F > ("w_delta_phi_ee",    "w_delta_phi_ee",   12, 0, TMath::Pi ());
  b_delta_wenuMet =          fs->make < TH1F > ("b_delta_phi_ee",    "b_delta_phi_ee",   12, 0, TMath::Pi ());
  c_delta_wenuMet =          fs->make < TH1F > ("c_delta_phi_ee",    "c_delta_phi_ee",   12, 0, TMath::Pi ());
  t_delta_wenuMet =          fs->make < TH1F > ("t_delta_phi_ee",    "t_delta_phi_ee",   12, 0, TMath::Pi ());
  w_delta_wenuMet_b =        fs->make < TH1F > ("w_delta_phi_ee_b",  "w_delta_phi_ee_b", 12, 0, TMath::Pi ());  
  b_delta_wenuMet_b =        fs->make < TH1F > ("b_delta_phi_ee_b",  "b_delta_phi_ee_b", 12, 0, TMath::Pi ());
  c_delta_wenuMet_b =        fs->make < TH1F > ("c_delta_phi_ee_b",  "c_delta_phi_ee_b", 12, 0, TMath::Pi ());
  t_delta_wenuMet_b =        fs->make < TH1F > ("t_delta_phi_ee_b",  "t_delta_phi_ee_b", 12, 0, TMath::Pi ());
  w_delta_wenuMet_bb =        fs->make < TH1F > ("w_delta_phi_ee_bb",  "w_delta_phi_ee_bb", 12, 0, TMath::Pi ());  
  b_delta_wenuMet_bb =        fs->make < TH1F > ("b_delta_phi_ee_bb",  "b_delta_phi_ee_bb", 12, 0, TMath::Pi ());
  c_delta_wenuMet_bb =        fs->make < TH1F > ("c_delta_phi_ee_bb",  "c_delta_phi_ee_bb", 12, 0, TMath::Pi ());
  t_delta_wenuMet_bb =        fs->make < TH1F > ("t_delta_phi_ee_bb",  "t_delta_phi_ee_bb", 12, 0, TMath::Pi ());
  w_delta_wmnuMet =          fs->make < TH1F > ("w_delta_phi_mm",    "w_delta_phi_mm",   12, 0, TMath::Pi ());
  b_delta_wmnuMet =          fs->make < TH1F > ("b_delta_phi_mm",    "b_delta_phi_mm",   12, 0, TMath::Pi ());
  c_delta_wmnuMet =          fs->make < TH1F > ("c_delta_phi_mm",    "c_delta_phi_mm",   12, 0, TMath::Pi ());
  t_delta_wmnuMet =          fs->make < TH1F > ("t_delta_phi_mm",    "t_delta_phi_mm",   12, 0, TMath::Pi ());
  w_delta_wmnuMet_b =        fs->make < TH1F > ("w_delta_phi_mm_b",  "w_delta_phi_mm_b", 12, 0, TMath::Pi ());
  b_delta_wmnuMet_b =        fs->make < TH1F > ("b_delta_phi_mm_b",  "b_delta_phi_mm_b", 12, 0, TMath::Pi ());
  c_delta_wmnuMet_b =        fs->make < TH1F > ("c_delta_phi_mm_b",  "c_delta_phi_mm_b", 12, 0, TMath::Pi ());
  t_delta_wmnuMet_b =        fs->make < TH1F > ("t_delta_phi_mm_b",  "t_delta_phi_mm_b", 12, 0, TMath::Pi ());
  w_delta_wmnuMet_bb =        fs->make < TH1F > ("w_delta_phi_mm_bb",  "w_delta_phi_mm_bb", 12, 0, TMath::Pi ());
  b_delta_wmnuMet_bb =        fs->make < TH1F > ("b_delta_phi_mm_bb",  "b_delta_phi_mm_bb", 12, 0, TMath::Pi ());
  c_delta_wmnuMet_bb =        fs->make < TH1F > ("c_delta_phi_mm_bb",  "c_delta_phi_mm_bb", 12, 0, TMath::Pi ());
  t_delta_wmnuMet_bb =        fs->make < TH1F > ("t_delta_phi_mm_bb",  "t_delta_phi_mm_bb", 12, 0, TMath::Pi ());
  ...
  w_single_delta_wenuMet_b =        fs->make < TH1F > ("w_single_delta_phi_ee_b",  "w_single_delta_phi_ee_b", 12, 0, TMath::Pi ());
  b_single_delta_wenuMet_b =        fs->make < TH1F > ("b_single_delta_phi_ee_b",  "b_single_delta_phi_ee_b", 12, 0, TMath::Pi ());
  c_single_delta_wenuMet_b =        fs->make < TH1F > ("c_single_delta_phi_ee_b",  "c_single_delta_phi_ee_b", 12, 0, TMath::Pi ());
  t_single_delta_wenuMet_b =        fs->make < TH1F > ("t_single_delta_phi_ee_b",  "t_single_delta_phi_ee_b", 12, 0, TMath::Pi ());
  w_single_delta_wmnuMet_b =        fs->make < TH1F > ("w_single_delta_phi_mm_b",  "w_single_delta_phi_mm_b", 12, 0, TMath::Pi ());
  b_single_delta_wmnuMet_b =        fs->make < TH1F > ("b_single_delta_phi_mm_b",  "b_single_delta_phi_mm_b", 12, 0, TMath::Pi ());
  c_single_delta_wmnuMet_b =        fs->make < TH1F > ("c_single_delta_phi_mm_b",  "c_single_delta_phi_mm_b", 12, 0, TMath::Pi ());
  t_single_delta_wmnuMet_b =        fs->make < TH1F > ("t_single_delta_phi_mm_b",  "t_single_delta_phi_mm_b", 12, 0, TMath::Pi ());

  w_single_delta_wenuMet_bb =        fs->make < TH1F > ("w_single_delta_phi_ee_bb",  "w_single_delta_phi_ee_bb", 12, 0, TMath::Pi ());
  b_single_delta_wenuMet_bb =        fs->make < TH1F > ("b_single_delta_phi_ee_bb",  "b_single_delta_phi_ee_bb", 12, 0, TMath::Pi ());
  c_single_delta_wenuMet_bb =        fs->make < TH1F > ("c_single_delta_phi_ee_bb",  "c_single_delta_phi_ee_bb", 12, 0, TMath::Pi ());
  t_single_delta_wenuMet_bb =        fs->make < TH1F > ("t_single_delta_phi_ee_bb",  "t_single_delta_phi_ee_bb", 12, 0, TMath::Pi ());
  w_single_delta_wmnuMet_bb =        fs->make < TH1F > ("w_single_delta_phi_mm_bb",  "w_single_delta_phi_mm_bb", 12, 0, TMath::Pi ());
  b_single_delta_wmnuMet_bb =        fs->make < TH1F > ("b_single_delta_phi_mm_bb",  "b_single_delta_phi_mm_bb", 12, 0, TMath::Pi ());
  c_single_delta_wmnuMet_bb =        fs->make < TH1F > ("c_single_delta_phi_mm_bb",  "c_single_delta_phi_mm_bb", 12, 0, TMath::Pi ());
  t_single_delta_wmnuMet_bb =        fs->make < TH1F > ("t_single_delta_phi_mm_bb",  "t_single_delta_phi_mm_bb", 12, 0, TMath::Pi ());
...
void WbAnalyzer::produce (edm::Event & iEvent, const edm::EventSetup & iSetup) {
  ...
  if (icut_==1 && Nb>0 && elept>0   && elept<30)   iflag_ee=true;
  if (icut_==2 && Nb>0 && elept>30  && elept<50)   iflag_ee=true;
  if (icut_==3 && Nb>0 && elept>50  && elept<80)   iflag_ee=true;
  if (icut_==4 && Nb>0 && elept>80  && elept<120)  iflag_ee=true;
  if (icut_==5 && Nb>0 && elept>120 && elept<400)  iflag_ee=true;
  
  if (icut_==1 && Nb>0 && muopt>0   && muopt<30)   iflag_mm=true;
  if (icut_==2 && Nb>0 && muopt>30  && muopt<50)   iflag_mm=true;
  if (icut_==3 && Nb>0 && muopt>50  && muopt<80)   iflag_mm=true;
  if (icut_==4 && Nb>0 && muopt>80  && muopt<120)  iflag_mm=true;
  if (icut_==5 && Nb>0 && muopt>120 && muopt<400)  iflag_mm=true;
  ...
  wenu_event = wenu_event && Nb>0 && Nj>0; // Get rid of some light jets :)
  wmnu_event = wmnu_event && Nb>0 && Nj>0; // Get rid of some light jets :)
  ...
  if (wmnu_event && mt_cut_wmnu && vtx_cut) {
    ...
    //    w_pt_Z_mm->Fill (dimuon_pt, MyWeight*scalFac_b);
    ...
    //    w_mt_Zj_mm->Fill (zj_mm_mass, MyWeight*scalFac_b);
    if (ist) {
      t_mt_wmnu->Fill (mt_wmnu, MyWeight*scalFac_b);
      //      b_pt_Z_mm->Fill (dimuon_pt, MyWeight*scalFac_b);
      //      b_mt_Zj_mm->Fill (zj_mm_mass, MyWeight*scalFac_b);
    ...
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 4) {
      ...
      //      c_mt_Zj_mm->Fill (zj_mm_mass, MyWeight*scalFac_b);
  ...
  if (wenu_event && vtx_cut) {
    ...
    w_first_ele_eta->Fill (vect_ele[0].ecalDrivenMomentum().eta(), MyWeight*scalFac_b);
    if (ee_event) { // temporary !!!
      w_second_ele_pt->Fill (vect_ele[1].ecalDrivenMomentum().pt(), MyWeight*scalFac_b);
      w_second_ele_eta->Fill (vect_ele[1].ecalDrivenMomentum().eta(), MyWeight*scalFac_b);
    }
#else
    ...
    if (ist) {
#if ECALDRIVEN>1
      t_first_ele_pt->Fill (vect_ele[0].ecalDrivenMomentum().pt(), MyWeight*scalFac_b);
      t_first_ele_eta->Fill (vect_ele[0].ecalDrivenMomentum().eta(), MyWeight*scalFac_b);
      if (ee_event) { // temporary !!!
        t_second_ele_pt->Fill (vect_ele[1].ecalDrivenMomentum().pt(), MyWeight*scalFac_b);
        t_second_ele_eta->Fill (vect_ele[1].ecalDrivenMomentum().eta(), MyWeight*scalFac_b);
      }
#else
    ...
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 5) {
#if ECALDRIVEN>1
      b_first_ele_pt->Fill (vect_ele[0].ecalDrivenMomentum().pt(), MyWeight*scalFac_b);
      b_first_ele_eta->Fill (vect_ele[0].ecalDrivenMomentum().eta(), MyWeight*scalFac_b);
      if (ee_event) { // temporary !!!
        b_second_ele_pt->Fill (vect_ele[1].ecalDrivenMomentum().pt(), MyWeight*scalFac_b);
        b_second_ele_eta->Fill (vect_ele[1].ecalDrivenMomentum().eta(), MyWeight*scalFac_b);
      }
#else
    ...
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 4) {
#if ECALDRIVEN>1
      c_first_ele_pt->Fill (vect_ele[0].ecalDrivenMomentum().pt(), MyWeight*scalFac_b);
      c_first_ele_eta->Fill (vect_ele[0].ecalDrivenMomentum().eta(), MyWeight*scalFac_b);
      if (ee_event) {
        c_second_ele_pt->Fill (vect_ele[1].ecalDrivenMomentum().pt(), MyWeight*scalFac_b);
        c_second_ele_eta->Fill (vect_ele[1].ecalDrivenMomentum().eta(), MyWeight*scalFac_b);
      }
#else
  ...
  if (wenu_event && mt_cut_wenu && vtx_cut && Nb > 1) {
    scalFac_b = btagSF(isMC, vect_jets, 2);
#if ECALDRIVEN>1
    w_first_ele_pt_bb->Fill (vect_ele[0].ecalDrivenMomentum().pt(), MyWeight*scalFac_b);
#else
