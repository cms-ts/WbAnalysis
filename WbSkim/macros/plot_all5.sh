...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp5.C+\($d,\"w_delta_phi_wenuMet\",1,$i\)
  root -l -q -b DataMCComp5.C+\($d,\"w_delta_phi_wmnuMet\",1,$i\)
  ...
  root -l -q -b DataMCComp5.C+\($d,\"w_delta_phi_wmnuMet_bb\",1,$i\)
