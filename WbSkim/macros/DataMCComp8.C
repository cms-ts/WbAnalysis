...
*/
	...
	for (int i=0;i<=h_data_stat->GetNbinsX()+1;i++) {
	  ...
	  val = TMath::Sqrt(TMath::Power(val,2)+TMath::Power(stat_qcd->GetBinError(i),2));
	...
	for (int i=0;i<=h_data_b_stat->GetNbinsX()+1;i++) {
	  ...
	  val = TMath::Sqrt(TMath::Power(val,2)+TMath::Power(stat_b_qcd->GetBinError(i),2));
	...
	xval = TMath::Sqrt(TMath::Power(xval,2)+TMath::Power(xsec_tot_stat_qcd,2));
	...
	xval = TMath::Sqrt(TMath::Power(xval,2)+TMath::Power(xsec_tot_stat_b_qcd,2));
