...
#  root -l -q -b DataMCComp.C+\($d,\"w_mt_wenu_wide\",1,$i,0,6\)
#  root -l -q -b DataMCComp.C+\($d,\"w_mt_wenu_b_wide\",1,$i,0,6\)
#  root -l -q -b DataMCComp.C+\($d,\"w_mt_wenu_bb_wide\",1,$i,0,6\)
#  root -l -q -b DataMCComp.C+\($d,\"w_mt_wmnu_wide\",1,$i,0,6\)
#  root -l -q -b DataMCComp.C+\($d,\"w_mt_wmnu_b_wide\",1,$i,0,6\)
#  root -l -q -b DataMCComp.C+\($d,\"w_mt_wmnu_bb_wide\",1,$i,0,6\)

  root -l -q -b DataMCComp.C+\($d,\"w_mt_wenu_wide\",1,$i,0,7\)
  root -l -q -b DataMCComp.C+\($d,\"w_mt_wenu_b_wide\",1,$i,0,7\)
  root -l -q -b DataMCComp.C+\($d,\"w_mt_wenu_bb_wide\",1,$i,0,7\)
  root -l -q -b DataMCComp.C+\($d,\"w_mt_wmnu_wide\",1,$i,0,7\)
...
while [ $i -le 8 ]; do
  ...
  root -l -q -b DataMCComp.C+\($d,\"w_pt_W_wenu\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_pt_W_wmnu\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_eta_W_wenu\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_eta_W_wmnu\",1,$i\)
  ...
  root -l -q -b DataMCComp.C+\($d,\"w_pt_W_wenu_b\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_pt_W_wmnu_b\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_eta_W_wenu_b\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_eta_W_wmnu_b\",1,$i\)
  ...
  root -l -q -b DataMCComp.C+\($d,\"w_pt_W_wenu_bb\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_pt_W_wmnu_bb\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_eta_W_wenu_bb\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_eta_W_wmnu_bb\",1,$i\)
  ...
  root -l -q -b DataMCComp.C+\($d,\"w_dijet_pt\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_dijet_eta\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_dijet_mass\",1,$i\)
  ...
  root -l -q -b DataMCComp.C+\($d,\"w_dijet_pt_b\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_dijet_eta_b\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_dijet_mass_b\",1,$i\)
  ...
  root -l -q -b DataMCComp.C+\($d,\"w_dijet_pt_bb\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_dijet_eta_bb\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_dijet_mass_bb\",1,$i\)
  ...
  root -l -q -b DataMCComp.C+\($d,\"w_MET_phi\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_MET_phi_b\",1,$i\)
  root -l -q -b DataMCComp.C+\($d,\"w_MET_phi_bb\",1,$i\)
