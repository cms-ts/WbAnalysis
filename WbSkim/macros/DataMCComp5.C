...
//    if (ilepton==2) mc5->cd(("demoMuoQCD"+postfix).c_str());
      TH1F* h_mc5_fit = 0;
//    h_mc5_fit = (TH1F*)gDirectory->Get(title_fit.c_str());
      ...
      if (h_mc5_fit) h_mc5_fit->Scale(norm5_fit);
      ...
      if (h_mc5_fit) h_data_fit->Add(h_mc5_fit, -1.);
