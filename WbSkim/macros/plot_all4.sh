...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_pt_bb\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_eta_b\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_eta_bb\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_mass_b\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_mass_bb\",1,$i,0\)
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_pt_W_wenu_bb\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_pt_W_wmnu_b\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_pt_W_wmnu_bb\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_eta_W_wenu_b\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_eta_W_wenu_bb\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_eta_W_wmnu_b\",1,$i,0\)
  root -l -q -b DataMCComp4.C+\($d,\"w_eta_W_wmnu_bb\",1,$i,0\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_pt_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_pt_bb\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_eta_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_eta_bb\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_mass_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_dijet_mass_bb\",1,$i\)

  root -l -q -b DataMCComp4.C+\($d,\"w_Ht_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Ht_bb\",1,$i\)

  root -l -q -b DataMCComp4.C+\($d,\"w_pt_W_wenu_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_pt_W_wenu_bb\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_pt_W_wmnu_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_pt_W_wmnu_bb\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_eta_W_wenu_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_eta_W_wenu_bb\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_eta_W_wmnu_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_eta_W_wmnu_bb\",1,$i\)

  root -l -q -b DataMCComp4.C+\($d,\"w_delta_wenu_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_delta_wenu_bb\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_delta_wmnu_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_delta_wmnu_bb\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_deltaR_wenu_b\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_deltaR_wenu_bb\",1,$i\)
  root -l -q -b DataMCComp4.C+\($d,\"w_deltaR_wmnu_b\",1,$i\)
