...
process.p = cms.Path(process.demoEle*process.demoEleQCD*process.demoEleFWD*process.demoEleTOP*process.demoMuo*process.demoMuoQCD*process.demoMuoFWD*process.demoMuoTOP*process.demoEleBtag*process.demoMuoBtag*process.demoEleGen*process.demoMuoGen)
